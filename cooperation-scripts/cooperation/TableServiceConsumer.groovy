...
public class TableServiceConsumer extends Table {
    ...
    public TableServiceConsumer(Sql db, Logger logger, String tableSuffix) {
        super(db, logger, "serviceconsumer", tableSuffix, SQL_CREATE_TABLE, SQL_INSERT)
    }
    ...
    public void addForeignKeys() {
        ...
        addForeignKeyConstraint("connection_point_id", "connectionpoint", "FK_serviceconsumer_1")
        addKey("connection_point_id", "IX_serviconsumer_1")
    }
    ...
    protected void addBatchEntries(Object input, String platform, String environment, BatchingPreparedStatementWrapper ps) {
        input.data.tjanstekonsument.each {
